...
Shader "Custom/HairShader" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float4 _DiffuseMapSpecA_ST;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 normalLocal = lerp(float3(0,0,1),_NormalMap_var.rgb,0);
                ...
                UnityGI gi = UnityGlobalIllumination(d, 1, normalDirection, 0 );
                ...
                float3 directSpecular = pow(max(0,dot(halfDirection,normalDirection)),1)*specularColor;
				...
				//Final Color:
                fixed4 finalRGBA = fixed4(diffuse + specular,1);
                return finalRGBA;
            }
            ENDCG
        }
